...
const MemberShipOptions = () => {
    return (
        <div className='container mx-auto mt-10'>
            ...
            <div className='pt-6 flex  justify-center items-center gap-10 md:grid md:grid-cols-2 lg:grid-cols-3'>
                {
                    [...Array(3).keys()].map((item, i) => {
                        return <div key={i} className={`p-4 ${i === 0 ? 'bg-[#EC9200]' : i === 1 ? 'bg-[#5D91F4]' : 'bg-[#163165]'} rounded-md text-center flex flex-col justify-center items-center gap-4 text-white py-8`}>
