        ...
        <footer className="p-6 bg-[#3475F1] text-white mt-10">
            <div className='container mx-auto'>
                <div className="grid grid-cols-2 gap-x-3 gap-y-8 sm:grid-cols-3">
                    <div className="flex flex-col space-y-4">
                        ...
                        <div className="flex flex-col space-y-2 text-sm ">
                            <Link to={`/facts`}>{language === "eng" ? "Facts" : "Hechos"}</Link>
                            <Link to={`/help-center`}>{language === "eng" ? "Help Center" : "Centro de Ayuda"}</Link>
                            <Link to={`/sponsor-ship`}>{language === "eng" ? "Sponsorship" : "Patrocinio"}</Link>
                            <Link to={`/rules-regulation`}>{language === "eng" ? "Rules & Regulation" : "Reglas y Regulaciones"}</Link>
                            <Link to={`/careers-opportunities`}>{language === "eng" ? "Careers + Job Opportunities" : "Carreras + Oportunidades Laborales"}</Link>
                        </div>
                    </div>
                    <div className="flex flex-col space-y-4">
                    ...
                    <div className="flex flex-col space-y-4">
                        <h2 className="font-medium">{language === "eng" ? "Like Us" : "Síguenos"}</h2>
                        <div className="flex flex-col space-y-2 text-sm ">
                            <Link rel="noopener noreferrer" className='flex justify-start items-center gap-2' href="#">
                                <FaFacebook />
                ...
                <div className="flex items-center justify-between pt-6 text-sm">
                    <span>
                        {language === "eng" ? "© Copyright 1986. All Rights Reserved." : "© Copyright 1986. Todos los Derechos Reservados."}
                    </span>
