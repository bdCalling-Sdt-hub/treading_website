...
const Chat = () => {
    return (
        <div className='container mx-auto md:grid grid-cols-7 mt-8 gap-6 '>
            <div className='col-span-3 bg-white p-3 rounded-md'>
                ...
                <div className='flex flex-col gap-4 justify-start items-start w-full'>
                    {
                        [...Array(6).keys()].map((item, i) => {
                            return <div className='flex justify-between items-start gap-2 hover:bg-black hover:bg-opacity-10 w-full rounded-md p-1 cursor-pointer' key={i}>
