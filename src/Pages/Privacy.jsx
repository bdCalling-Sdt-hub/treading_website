const Privacy = () => {
  return (
    <div className="max-w-3xl mx-auto p-6 bg-white shadow-md rounded-lg text-gray-800">
      ...
      <ul className="list-disc pl-6 mb-4">
        ...
        <li className="mb-2">
          <strong>Application</strong> refers to SwiftSwap, the software program
      ...
      <p className="font-semibold text-gray-700">
        By email:{" "}
        <a href="mailto:swiftswap123@gmail.com" classname="text-blue-500">
          swiftswap123@gmail.com
        </a>
      </p>
    </div>
  );
