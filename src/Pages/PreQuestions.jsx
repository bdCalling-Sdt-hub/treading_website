...
const PreQuestions = () => {
    if (!localStorage.getItem('token')) return <Navigate to={`/sign-in`}></Navigate> 
    const { id } = useParams();
    ...
    const onFinish = (values) => {
        const formattedValues = {
            ...
            departureArrival: values.departureArrival ? values.departureArrival.format("YYYY-MM-DD") : null,
            datesOfTravel: values.datesOfTravel ? values.datesOfTravel.format("YYYY-MM-DD") : null,
            plan_type: plan_type,
        ...
        <div className="bg-white container mx-auto p-8 rounded-lg shadow-lg mt-10">
            ...
            >
                ...
                <Form.Item
                    ...
                    rules={[{ required: true, message: 'Please enter your travel start destination.' }]}
                >
                ...
                <Form.Item
                    ...
                    name="startState"
                    rules={[{ required: true, message: 'Please enter your travel start state.' }]}
                >
                ...
                <Form.Item
                    ...
                    rules={[{ required: true, message: 'Please enter your travel start county.' }]}
                >
                ...
                <Form.Item
                    ...
                    rules={[{ required: true, message: 'Please enter your travel start country.' }]}
                >
                ...
                <Form.Item
                    ...
                    name="endDestination"
                    rules={[{ required: true, message: 'Please enter your travel end destination.' }]}
                >
                ...
                <Form.Item
                    ...
                    name="endState"
                    rules={[{ required: true, message: 'Please enter your travel end state.' }]}
                >
                ...
                <Form.Item
                    ...
                    name="endCounty"
                    rules={[{ required: true, message: 'Please enter your travel end county.' }]}
                >
                ...
                <Form.Item
                    ...
                    name="endCountry"
                    rules={[{ required: true, message: 'Please enter your travel end country.' }]}
                >
                ...
                <Form.Item
                    ...
                    rules={[{ required: true, message: 'Please enter the purpose of your travel.' }]}
                >
                ...
                <Form.Item
                    ...
                    rules={[{ required: true, message: 'Please select your departure arrival date.' }]}
                >
                    <DatePicker style={{ width: '100%' }} />
                </Form.Item>
                ...
                <Form.Item
                    ...
                    name="datesOfTravel"
                    rules={[{ required: true, message: 'Please select your dates of travel.' }]}
                >
                    <DatePicker style={{ width: '100%' }} />
                </Form.Item>
                ...
                <Form.Item
                    ...
                    name="haveChildren"
                    rules={[{ required: true, message: 'Please select if you have children.' }]}
                >
                ...
                <Form.Item
                    ...
                    name="havePets"
                    rules={[{ required: true, message: 'Please select if you have pets.' }]}
                >
                    <Radio.Group onChange={onChange}>
                        <Radio value="Yes">Yes</Radio>
                        <Radio value="No">No</Radio>
                ...
                <Form.Item
                    ...
                    name="haveVehicle"
                    rules={[{ required: true, message: 'Please select if you own a vehicle.' }]}
                >
                    <Radio.Group onChange={onChange}>
                        <Radio value="Yes">Yes</Radio>
                        <Radio value="No">No</Radio>
                ...
                <Form.Item
                    ...
                    name="willingVehicle"
                    rules={[{ required: true, message: 'Please select if you are willing to swap your vehicle.' }]}
                >
                    <Radio.Group onChange={onChange}>
                        <Radio value="Yes">Yes</Radio>
                        <Radio value="No">No</Radio>
                ...
                <Form.Item
                    ...
                    rules={[{ required: true, message: 'Please select if you own the property.' }]}
                >
                    <Radio.Group onChange={onChange}>
                        <Radio value="Yes">Yes</Radio>
                        <Radio value="No">No</Radio>
                ...
                <Form.Item
                    ...
                    rules={[{ required: true, message: 'Please select if the property is insured.' }]}
                >
                    <Radio.Group onChange={onChange}>
                        <Radio value="Yes">Yes</Radio>
                        <Radio value="No">No</Radio>
                ...
                <Form.Item
                    ...
                    rules={[{ required: true, message: 'Please select if utilities are up-to-date.' }]}
                >
                    <Radio.Group onChange={onChange}>
                        <Radio value="Yes">Yes</Radio>
                        <Radio value="No">No</Radio>
                ...
                <Form.Item
                    ...
                    rules={[{ required: true, message: 'Please select if you are able to approve the form.' }]}
                >
                    <Radio.Group onChange={onChange}>
                        <Radio value="Yes">Yes</Radio>
                        <Radio value="No">No</Radio>
                ...
                <Form.Item
                    label="About Swap"
                    name="aboutSwap"
                    rules={[{ required: true, message: 'Please provide details about the swap.' }]}
                >
                    <Input.TextArea style={{
                        resize:'none'
                    }} rows={3} placeholder="Enter details about the swap" />
                </Form.Item>
