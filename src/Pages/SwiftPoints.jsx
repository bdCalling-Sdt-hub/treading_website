  ...
  return (
    <div className="container mx-auto mt-4">
      <div className="flex justify-between items-center gap-4">
        <div className="flex justify-between items-center gap-4">
          <p className="text-3xl font-medium text-[#4E4E4E] ">
            Swap Points History
          </p>
        ...
        {isLoading ? (
          ...
          data?.data.map((item, i) => {
            return (
              <div
                key={i}
                className="flex justify-between md:flex-row flex-col items-center w-full pb-4 border-b"
              >
                <div className="md:w-[45%] w-full flex justify-between items-center gap-[2%]">
                  <div className="w-[25%] flex justify-center items-center">
                    <img
                      src={imageUrl(item?.productTo?.images?.[0])}
                  ...
                  <div className="w-[73%]">
                    <div className="flex justify-start items-center gap-4">
                      <p className=" text-[#4E4E4E]">
                        Swap on {moment(item?.createdAt).format("LLL")}{" "}
                      </p>
                      <p className=" text-[#4E4E4E] flex justify-start items-center gap-2">
                        {" "}
                        <span>Condition:</span> {item?.productTo?.condition}
                      </p>
                    </div>
                    <p className="text-xl font-semibold mt-2">
                      {item?.productTo?.title}
                    </p>
                ...
                <div className="md:w-[45%] w-full flex justify-between items-center gap-[2%]">
                  <div className="w-[25%] flex justify-center items-center">
                    <img
                      src={imageUrl(item?.productFrom?.images?.[0])}
                      className="w-full object-contain"
                      alt=""
                    />
                  </div>
                  <div className="w-[73%]">
                    <div className="flex justify-start items-center gap-4">
                      ...
                      <p className=" text-[#4E4E4E] flex justify-start items-center gap-2">
                        {" "}
                        <span>Condition:</span> {item?.productFrom?.condition}
                      </p>
                    </div>
                    <p className="text-xl font-semibold mt-2">
                      {item?.productFrom?.title}
                    </p>
                    <div className="flex justify-start items-center w-full gap-1 my-2 flex-wrap">
                      <p className=" text-[#4E4E4E] flex justify-start items-center gap-2">
                        {" "}
                    ...
                    <div className="flex justify-start items-center w-full gap-1 my-2 flex-wrap">
                      <p className=" text-[#4E4E4E] flex justify-start items-center gap-2">
                        ...
                        <span>Post by: </span>{" "}
                        <span className="text-blue-600 ">
                          {item?.productFrom?.user?.name}{" "}
                        </span>
                      </p>
                      <p className=" text-[#4E4E4E] flex justify-start items-center gap-2">
                        <GrLocation className=" text-2xl" />{" "}
                        {item?.productFrom?.user?.address}
                      </p>
                    </div>
                  </div>
                </div>
                <div className="md:w-[6%] w-full flex flex-col justify-center items-center ">
                  <p className=" text-[#4E4E4E] flex justify-start flex-col items-center gap-2 ">
                    <FaRegStar className="text-yellow-400 text-2xl" />{" "}
                    {item?.swapUserFromPoint + item?.swapUserToPoint} Points
                  </p>
                </div>
              </div>
            );
