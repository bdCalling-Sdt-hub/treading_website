    ...
    return (
        <div className='container mx-auto md:grid grid-cols-3 flex flex-col mt-10 gap-6'>
            ...
            <div className='w-full col-span-2 p-6 rounded-md text-[#4E4E4E] '>
                ...
                <p className=' flex justify-start items-center gap-2'>By swapping you can earn up to  <FaRegStar className='text-yellow-400 text-2xl' /> {data?.data?.point} Points</p>
                <div className='flex justify-start items-center gap-2 mt-3'>
                    ...
                    <div>
                        ...
                        <p className=' text-[#4E4E4E] flex justify-start items-center gap-2'><FaStar className='text-yellow-400 text-2xl' /> {data?.data?.ratting}/5.0</p>
                    </div>
                </div>
